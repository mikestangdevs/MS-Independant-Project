        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=essql1.walton.uark.edu;Initial Catalog=PROJECTS2326;user id=PROJECTS2326;password=GohogsUA1;Persist Security Info=False;";
                }
